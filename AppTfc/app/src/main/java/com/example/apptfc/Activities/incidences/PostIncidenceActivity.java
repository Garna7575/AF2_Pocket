package com.example.apptfc.Activities.incidences;
...
public class PostIncidenceActivity extends AppCompatActivity {
    ...
    private static final long COOLDOWN_PERIOD = 15 * 60 * 1000;
    ...
    private void createIncidence(SharedPreferences prefs) {
